...
namespace Logikfabrik.Umbraco.Jet.Test.Web.Data
{
    ...
    public class DocumentServiceTest
    {
        ...
        {
            builder.AddProperty(Scope.Public, Accessor.GetSet, "DocumentTypeId", documentTypeId.GetType());
        ...
        {
            builder.AddProperty(Scope.Public, Accessor.GetSet, "DocumentTypeAlias", documentTypeAlias.GetType());
